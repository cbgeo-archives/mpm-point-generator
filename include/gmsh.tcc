...
template <unsigned Tdim, unsigned Tvertices>
void GMSH<Tdim, Tvertices>::compute_volumes() {
  ...
  for (unsigned t = firstelementcoord; t < lastelementcoord + 1; ++t) {
    ...
    if (coordinatesfind != elementcoordinates_.end()) {
      ...
      Eigen::Vector3d a(m(0, 3), m(1, 3), m(2, 3)),
          b(m(0, 2), m(1, 2), m(2, 2)), c(m(0, 1), m(1, 1), m(2, 1)),
          d(m(0, 0), m(1, 0), m(2, 0)), e(m(0, 7), m(1, 7), m(2, 7)),
          f(m(0, 6), m(1, 6), m(2, 6)), g(m(0, 5), m(1, 5), m(2, 5)),
          h(m(0, 4), m(1, 4), m(2, 4));
      ...
      volumes_.insert(std::make_pair(coordinatesfind->first, volume));
    }
  }
