...
template <unsigned Tdim> void Mesh<Tdim>::get_vertices(const std::string& filename) {
...
template <unsigned Tdim> void Mesh<Tdim>::get_elements(const std::string& filename) {
